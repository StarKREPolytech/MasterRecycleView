...
* A Kotlin history was added and callback systems were changed in favor of lambdas to match with Kotlin language.
* In order to not disadvantage Java users I kept the previous methods. Both Java and kotlin histories are available in this repository.
...
The building of the sections will be automatically taken care of by a lambda that you must provide in your constructor ()`{ history -> history.rate }`).
